...
class AssignService(ChannelSelectionBase):
	if screenWidth == 1920:
		...
		<screen name="IPToSAT Service Assign" position="1,80" size="1920,1020" backgroundColor="#0023262f" title="IPToSAT Service Assign">
			...
			<widget name="list" position="23,42" size="630,338" backgroundColor="#0023262f" scrollbarMode="showOnDemand" scrollbarForegroundColor="#0044a2ff" scrollbarBorderColor="#0044a2ff" />
			<widget name="list2" position="680,42" size="590,305" backgroundColor="#0023262f" scrollbarMode="showOnDemand" scrollbarForegroundColor="#0044a2ff" scrollbarBorderColor="#0044a2ff" />
		...
		if self.storage:
			...
			try:
				...
				if exists(str(iptosatlist1conf)) or exists(str(iptosatlist2conf)):
					config.plugins.IPToSAT.usercategories.value = False
					config.plugins.IPToSAT.usercategories.save()
				if not config.plugins.IPToSAT.usercategories.value and config.plugins.IPToSAT.typecategories.value == "all":
