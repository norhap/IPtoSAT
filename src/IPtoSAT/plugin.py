	...
	def doinstallChannelsList(self, answer):
		try:
			...
			if answer:
				...
				command = 'init 3 ; mount -a'  if BoxInfo.getItem("socfamily") != "hisi3798mv200" and not exists(str(self.backupdirectory) + '/zerotier-one') else 'init 6'
